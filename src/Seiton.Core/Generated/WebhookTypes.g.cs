...
internal static class WebhookTypes
{
    ...
    internal readonly struct EventSpec
    {
        ...
        public bool IsOptionAllowed(ReadOnlySpan<byte> optionUtf8)
        {
            return Id switch
            {
                ...
                EventId.MergeGroup => optionUtf8.SequenceEqual("branches"u8) || optionUtf8.SequenceEqual("branches-ignore"u8) || optionUtf8.SequenceEqual("types"u8),
                ...
                EventId.PullRequest => optionUtf8.SequenceEqual("branches"u8) || optionUtf8.SequenceEqual("branches-ignore"u8) || optionUtf8.SequenceEqual("paths"u8) || optionUtf8.SequenceEqual("paths-ignore"u8) || optionUtf8.SequenceEqual("types"u8),
                ...
                EventId.PullRequestTarget => optionUtf8.SequenceEqual("branches"u8) || optionUtf8.SequenceEqual("branches-ignore"u8) || optionUtf8.SequenceEqual("paths"u8) || optionUtf8.SequenceEqual("paths-ignore"u8) || optionUtf8.SequenceEqual("types"u8),
                ...
                EventId.WorkflowRun => optionUtf8.SequenceEqual("branches"u8) || optionUtf8.SequenceEqual("branches-ignore"u8) || optionUtf8.SequenceEqual("types"u8) || optionUtf8.SequenceEqual("workflows"u8),
                _ => false,
            };
        }
    ...
    internal static readonly string[] AllEventNames =
    [
        ...
        "gollum", "image_version", "issue_comment", "issues", "label",
