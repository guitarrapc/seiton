...
public sealed class OnlineAuditEngineTests
{
    ...
    public async Task AuditAsync_PassThrough_WhenProvidersReturnNoData()
    {
        ...
        var source = Encoding.UTF8.GetBytes(
            ...
            """);
        using var lintResult = engine.Check(source, "workflow.yml", EnableAllOnlineRules());
    ...
    public async Task AuditAsync_ReturnsPassThrough_WhenOnlineRulesNotEnabled()
    {
        ...
        using var lintResult = engine.Check(source, "workflow.yml");
            ...
            jobs:
              build:
                ...
                steps:
                  - uses: actions/checkout@v4
            """);
        using var ignored = engine.Check(source, "workflow.yml", EnableAllOnlineRules());
