...
- `ghcr.io/guitarrapc/seiton:0.9.16`
- `ghcr.io/guitarrapc/seiton:v0.9.16`
  ...
  seiton:
    ...
    steps:
      ...
      - name: Run seiton in Docker
        run: docker run --rm -v "$PWD:/repo:ro" ghcr.io/guitarrapc/seiton:v0.9.16 --format sarif > seiton.sarif
