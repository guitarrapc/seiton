...
- `Docs/architecture_spec_csharp.md`
- `Docs/Seiton_Parser_spec.md` — パーサー仕様（言語非依存）
- `Docs/Seiton_Parser_csharp_spec.md` — C# 実装仕様
- `Docs/parser_implementation_csharp_plan.md` — C# 実装計画
- `Docs/architecture_spec_performance.md`
